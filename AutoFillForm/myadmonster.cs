...
{
   public class myadmonster:IWebSites
    {
       ...
       public void carpostfunc(WebBrowser webBrowser1, IList<com.unitedcarexchange.UsedCarsInfo> obUsedCarsInfo,bool a)
       {
           ...
           GeneralFunction.SetTextvaluebyName(webBrowser1, "email", Globaltxtemail.txtemail);
           GeneralFunction.SetTextvaluebyName(webBrowser1, "username", "UCEURV");
           GeneralFunction.SetTextvaluebyName(webBrowser1, "password", Globalpwd.pwd);
           GeneralFunction.SetTextvaluebyName(webBrowser1, "zip", obUsedCarsInfo[0].Zip.ToString());
           GeneralFunction.SetTextvaluebyName(webBrowser1, "phone", obUsedCarsInfo[0].Phone.ToString());

           if (obUsedCarsInfo[0].Price.ToString() == "0")
           {
               GeneralFunction.SetTextvaluebyName(webBrowser1, "price", "$1");
           }
           ...
           else
           {
               ...
               GeneralFunction.SetTextvaluebyName(webBrowser1, "price", price1);
           }
           ...
           {
               if (obUsedCarsInfo[0].Model == "Other")
           ...
           GeneralFunction.SetTextvaluebyName(webBrowser1, "title", title);
         ...
         //  string fule = obUsedCarsInfo[0].Fueltype.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Fueltype.ToString() == "Unspecified" ? "" : "\r\nFuelType: " + obUsedCarsInfo[0].Fueltype.ToString();
           ...
           GeneralFunction.SetMultiTextValue(webBrowser1, "content", URLDesp);
       }
           ...
           if (objText != null)
           {
               ...
               if (objText.ToString().Trim() != "")
               {
                   ...
                   if (objText.ToString().Trim().Length > intMaxChars)
                   {
                       ...
                       strReturnValue = details.ToString() + "\r\n" +"\n"+ "Description: " + objText.ToString().Substring(0, intMaxChars) +
