...
{
   public class freead1:IWebSites
    {
       ...
       public void carpostfunc(WebBrowser webBrowser1, IList<com.unitedcarexchange.UsedCarsInfo> obUsedCarsInfo,bool a)
       {
           ...
           GeneralFunction.SetDropDownNameandValue(webBrowser1, "cat", "3");

           GeneralFunction.SetDropDownNameandValue(webBrowser1, "subcat", "82");
           ...
           GeneralFunction.SetMultiTextValue(webBrowser1, "text", URLDesp);
           GeneralFunction.SetTextValue(webBrowser1, "email", Globaltxtemail.txtemail);
           GeneralFunction.SetTextValue(webBrowser1, "www", url);

           GeneralFunction.ButtonClickInvoke(webBrowser1, "pic1");
           GeneralFunction.ButtonClickInvoke(webBrowser1, "pic3");
           GeneralFunction.ButtonClickInvoke(webBrowser1, "pic2");
             string statename1 = StateName.GetStateName(obUsedCarsInfo, obUsedCarsInfo[0].State.ToString(), obUsedCarsInfo[0].Carid.ToString());
           GeneralFunction.SetDropDownValue(webBrowser1,"state",statename1);
           GeneralFunction.SetDropDownValue(webBrowser1, "group", obUsedCarsInfo[0].Make.ToString());
