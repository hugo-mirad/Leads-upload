...
namespace AutoFillForm
{
    class webfreeads:IWebSites
    {
        ...
        public void carpostfunc(System.Windows.Forms.WebBrowser webBrowser1, IList<AutoFillForm.com.unitedcarexchange.UsedCarsInfo> obUsedCarsInfo, bool a)
        {
            ...
            URLDesp = WrapTextByMaxCharacters(details, obUsedCarsInfo[0].Description.ToString(), 300, url, obUsedCarsInfo[0].Phone.ToString());
            string title = "";
            ...
            GeneralFunction.SetTextValue(webBrowser1, "price", obUsedCarsInfo[0].Price.ToString() == "0" ? "1" : obUsedCarsInfo[0].Price.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Price.ToString() == "Unspecified" ? "" : obUsedCarsInfo[0].Price.ToString());
            GeneralFunction.SetTextValue(webBrowser1, "x[1]", obUsedCarsInfo[0].YearOfMake.ToString() == "Emp" ? "" : obUsedCarsInfo[0].YearOfMake.ToString() == "Unspecified" ? "" : obUsedCarsInfo[0].YearOfMake.ToString());
            GeneralFunction.SetTextValue(webBrowser1, "x[2]", obUsedCarsInfo[0].Mileage.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Mileage.ToString() == "Unspecified" ? "" : obUsedCarsInfo[0].Mileage.ToString());
            GeneralFunction.SetTextValue(webBrowser1, "x[3]", obUsedCarsInfo[0].Bodytype.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Bodytype.ToString() == "Unspecified" ? "" : obUsedCarsInfo[0].Bodytype.ToString());
            GeneralFunction.SetTextValue(webBrowser1, "x[4]", obUsedCarsInfo[0].Transmission.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Transmission.ToString() == "Unspecified" ? "" :  obUsedCarsInfo[0].Transmission.ToString());
            GeneralFunction.SetTextValue(webBrowser1, "x[5]", obUsedCarsInfo[0].Fueltype.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Fueltype.ToString() == "Unspecified" ? "" : obUsedCarsInfo[0].Fueltype.ToString());
            GeneralFunction.SetTextValue(webBrowser1, "x[6]", obUsedCarsInfo[0].ExteriorColor.ToString() == "Emp" ? "" : obUsedCarsInfo[0].ExteriorColor.ToString() == "Unspecified" ? "" : obUsedCarsInfo[0].ExteriorColor.ToString());
            GeneralFunction.SetTextValue(webBrowser1, "x[7]", obUsedCarsInfo[0].NumberOfCylinder.ToString() == "Emp" ? "" : obUsedCarsInfo[0].NumberOfCylinder.ToString() == "Unspecified" ? "" : obUsedCarsInfo[0].NumberOfCylinder.ToString());
            //GeneralFunction.SetTextValue(webBrowser1, "x[8]", "9000");
