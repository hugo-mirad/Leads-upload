...
{
   public class Pintrest:IWebSites
    {
       ...
       public void carpostfunc(WebBrowser webBrowser1, IList<com.unitedcarexchange.UsedCarsInfo> obUsedCarsInfo,bool a)
       {
           ...
           string location = obUsedCarsInfo[0].YearOfMake.ToString() + " " + obUsedCarsInfo[0].Make.ToString() + " " + obUsedCarsInfo[0].Model.ToString();
           GeneralFunction.SetTextvaluebyName(webBrowser1, "name", location);
           ...
           string URLDesp = WrapTextByMaxCharacters(details, dep, val);
           ...
           GeneralFunction.SetDropDownNameandValue(webBrowser1, "category", "cars_motorcycles");
           GeneralFunction.ButtonClickspan(webBrowser1, "buttonText");
        
       }



       string WrapTextByMaxCharacters(string details, string objText, int intMaxChars)
       {
