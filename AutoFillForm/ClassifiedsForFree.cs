...
{
    public class ClassifiedsForFree : IWebSites
    {
        ...
        public void carpostfunc(WebBrowser webBrowser1, IList<com.unitedcarexchange.UsedCarsInfo> obUsedCarsInfo,bool a)
        {
            ...
            GeneralFunction.SetTextValue(webBrowser1, "UserName", username);
            GeneralFunction.SetTextValue(webBrowser1, "Password", Globalpwd.pwd);
            GeneralFunction.SetTextValue(webBrowser1, "ConfirmPassword", Globalpwd.pwd);
            GeneralFunction.SetTextValue(webBrowser1, "Email", Globaltxtemail.txtemail);
            GeneralFunction.SetTextValue(webBrowser1, "LastName", username);
            GeneralFunction.SetTextValue(webBrowser1, "FirstName", username);

            //************ClassifiedsForFree
            GeneralFunction.SetDropDownValue(webBrowser1, "WorldCountry", "United States");
            string title = "";
            ...
            GeneralFunction.SetTextValue(webBrowser1, "Header", title);
            GeneralFunction.SetDropDownValue(webBrowser1, "Category", "Automobiles");
            ...
            //GeneralFunction.SetDropDownValue(webBrowser1, "f_selectedPlace", statename);
            //string city = obUsedCarsInfo[0].City.ToString() + " " + obUsedCarsInfo[0].State.ToString() + " " + obUsedCarsInfo[0].Zip.ToString();
            //GeneralFunction.SetDropDownValue(webBrowser1, "select-city", city);
            //GeneralFunction.SetDropDownValue(webBrowser1, "f_selectedCategory", "Automobiles");

            ////string yr = obUsedCarsInfo[0].YearOfMake.ToString();
            ////string mk = obUsedCarsInfo[0].Make.ToString();
            ////string mdl = obUsedCarsInfo[0].Model.ToString();
            ////string mlg = obUsedCarsInfo[0].Mileage.ToString();
            ////string title = yr + "  " + mk + "  " + mdl + "  " + mlg + "mileage";

            //string clztitle = obUsedCarsInfo[0].YearOfMake.ToString() + " " + obUsedCarsInfo[0].Make.ToString() + " " + obUsedCarsInfo[0].Model.ToString();
            //GeneralFunction.SetTextValue(webBrowser1, "f_header", clztitle);
           // GeneralFunction.SetTextValue(webBrowser1, "f_email", Globaltxtemail.txtemail);
            ...
            string url = "http://www.classifiedsforfree.com/UnitedCarExchange.com/a1/" + pyear + "-" + pmake + "-" + pmodel + "-" + caruniqueid + "";
            if (url.Contains(" "))
            {
                url = url.Replace(" ", "%20");
            }
           ...
           // string fule = obUsedCarsInfo[0].Fueltype.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Fueltype.ToString() == "Unspecified" ? "" : "\r\nFuelType: " + obUsedCarsInfo[0].Fueltype.ToString();
            ...
            if (dep.Contains("Emp"))
            {
                ...
                dep = (make.Trim() == "" ? "" : make.Trim()) + (model.Trim() == "" ? "" : "\r\n" + model.Trim()) + (year.Trim() == "" ? "" : "\r\n" + year.Trim()) + (doors.Trim() == "" ? "" : "\r\n" + doors.Trim()) + (bodystyle.Trim() == "" ? "" : "\r\n" + bodystyle.Trim()) + (exteriorcolor.Trim() == "" ? "" : "\r\n" + exteriorcolor.Trim()) + (interior.Trim() == "" ? "" : "\r\n" + interior.Trim());
            ...
            //GeneralFunction.SetTextValue(webBrowser1, "f_image_url1", GetPic0(obUsedCarsInfo));
            //GeneralFunction.SetTextValue(webBrowser1, "f_image_url2", GetPic1(obUsedCarsInfo));
            //GeneralFunction.SetTextValue(webBrowser1, "f_image_url3", "");
            ...
            GeneralFunction.FileUploadInvoke(webBrowser1, "image");//ImgeUpload
            //GeneralFunction.FileUploadInvoke(webBrowser1, "f_userfile2");
            //GeneralFunction.FileUploadInvoke(webBrowser1, "f_userfile3");
           // GeneralFunction.FileUploadInvoke(webBrowser1, "f_userfile2");//ImgeUpload
//GeneralFunction.FileUploadInvoke(webBrowser1, "f_userfile3");//ImgeUpload
