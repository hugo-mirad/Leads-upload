...
{
    class classifiedsvalley1:IWebSites
    {
        ...
        {
            string clztitle = "";// obUsedCarsInfo[0].Model.ToString();
            ...
            GeneralFunction.SetTextValue(webBrowser1, "b[classified_title]", clztitle);
            ...
            GeneralFunction.SetTextValue(webBrowser1, "b[question_value][92]", obUsedCarsInfo[0].Make.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Make.ToString() == "Unspecified" ? "" : obUsedCarsInfo[0].Make.ToString());
            GeneralFunction.SetTextValue(webBrowser1, "b[question_value][93]", obUsedCarsInfo[0].Model.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Model.ToString() == "Unspecified" ? "" :obUsedCarsInfo[0].Model.ToString());
            GeneralFunction.SetTextValue(webBrowser1, "b[price]", obUsedCarsInfo[0].Price.ToString() == "0" ? "1" : obUsedCarsInfo[0].Price.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Price.ToString() == "Unspecified" ? "" : obUsedCarsInfo[0].Price.ToString());
            ...
            URLDesp = URLDesp + "\r\n http://" + url;
            GeneralFunction.SetMultiTextValue(webBrowser1, "b[description]", URLDesp);
            ...
            if (objText != null)
            {
                ...
                if (objText.ToString().Trim() != "")
                {
                   if (objText.ToString().Trim().Length > intMaxChars)
                    {
                        strReturnValue = details.ToString() + "\r\n" + "\n" + "Description: " + objText.ToString().Trim().Substring(0,intMaxChars) + "..!! If intrested contact : " + phone;
                    }
                    else
                    {
    ...
    //public static class Globalstname
    //{
