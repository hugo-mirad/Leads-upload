...
{
    public class classifiedsciti : IWebSites
    {
        ...
        public void carpostfunc(WebBrowser webBrowser1, IList<com.unitedcarexchange.UsedCarsInfo> obUsedCarsInfo,bool a)
        {
            ...
            //  GeneralFunction.SetTextValue(webBrowser1, "listcurrency", "USD");
            string clztitle = "";
          ...
          //  string fule = obUsedCarsInfo[0].Fueltype.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Fueltype.ToString() == "Unspecified" ? "" : "\r\nFuelType: " + obUsedCarsInfo[0].Fueltype.ToString();
            ...
            string URLDesp = details.ToString() + "\r\n" + "\n" + "Description: " + dep.Trim() + "..!!!For More Details:  " + url;
                //WrapTextByMaxCharacters(details, dep, val, url, pn);

            GeneralFunction.SetDivValuebyInnerText(webBrowser1, "nicEdit-main", URLDesp);
            GeneralFunction.SetDropDownName(webBrowser1, "location", "USA");
            string city = obUsedCarsInfo[0].City.ToString() + " " + obUsedCarsInfo[0].State.ToString() + " " + obUsedCarsInfo[0].Zip.ToString();
            GeneralFunction.SetTextValue(webBrowser1, "place", city);
            GeneralFunction.SetTextValue(webBrowser1, "name", "UCEURV");
