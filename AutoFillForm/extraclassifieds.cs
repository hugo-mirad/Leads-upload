...
{
    class extraclassifieds:IWebSites
    {
        ...
        public void carpostfunc(System.Windows.Forms.WebBrowser webBrowser1, IList<AutoFillForm.com.unitedcarexchange.UsedCarsInfo> obUsedCarsInfo, bool a)
        {
            ...
            URLDesp = details.ToString() + "\r\n" + "\n" + "Description: " + dep.Trim() + "..!! If intrested contact : " + pn
                                        + "..!!!For More Details:  "; 
            //WrapTextByMaxCharacters(details, obUsedCarsInfo[0].Description.ToString(), 300, url, obUsedCarsInfo[0].Phone.ToString());
            string title = "";
            ...
            GeneralFunction.SetMultiTextValue(webBrowser1, "description[en_US]", URLDesp+url);
