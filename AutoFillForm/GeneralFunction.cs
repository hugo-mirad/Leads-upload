...
namespace AutoFillForm
{
    public static class GeneralFunction
    {
        ...
        //public static void SelectOption(WebBrowser objbrowser, string InnerTxt, String ControlName)
        //{
        //    try
        //    {
        ...
        ////public static void SetTextBytypeNumber(WebBrowser objbrowser, string ControlName, string ControlInnerText)
        ////{
        ////    try
        ////    {
        ////        objbrowser.Document.GetElementById(ControlName).InnerText = ControlInnerText;
        ...
        ////    { }
        ////}
        //public static void SetMultiTextValueLink(WebBrowser objbrowser, string ControlName, string ControlInnerText)
        //{
        //    try
        //    {
        //        objbrowser.Document.GetElementsByTagName("textarea").GetElementsByName(ControlName).InnerText = ControlInnerText;
        //    }
        //    catch (Exception ex)
        //    { }
        //}
        //public static void ImgeButtonClickFB(WebBrowser objbrowser)
        //{
        //    try 
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("i"))
        //        {
        //            //for (int i = 0; i < element.Children.Count; i++)
        //            // {
        //            if (element.GetAttribute("classname").Trim() == "img sp_73zvi5 sx_7b4147")
        //            {
        //                element.InvokeMember("click");
        //                return;
        //            }
        ...
        //    { }
        //}
        //public static void HfSpanClickInvoke(WebBrowser objbrowser, string ControlTitle)
        //{
        //    try
        //    {

        //        HtmlElementCollection links = objbrowser.Document.GetElementsByTagName("");
        //        foreach (HtmlElement link in links)  // this ex is given another SO post 
        //        {
        //            if (link.InnerHtml.Equals("<span class=\"dropmenuspan\">US States</span>"))
        //                link.InvokeMember("Click");
        //        }
        //        //foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("a"))
        //        // {
        ...
        //    { }
        //}
        //public static void LinkInvokestate(WebBrowser objbrowser, string InnerTxt)
        //{
        //    try
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("a"))
        ...
        //    { }
        //}
        //public static void FileUploadSetValue(WebBrowser objbrowser,string ControlName, string ImgPath)
        //{
        //   try
        //   {
        ...
        //   { }
        //}
        //public static void SetClassValue2(WebBrowser objbrowser, string controlName, string Controlvalue)
        //{
        //    try
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("input"))
        ...
        //            {
        //                element.SetAttribute("value", Controlvalue);
        //                // objbrowser.Document.GetElementById(controlName).InnerText = Controlvalue;
        //                // element.SetAttribute("adtitle", Controlvalue);
        //            }
        ...
        //public static void SetDesText(WebBrowser objbrowser, string controlName, string Controlvalue)
        //{
        //    try
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("textarea"))
        ...
        //}
        //public static void SetTextValue1(WebBrowser objbrowser, string ControlName, string ControlInnerText)
        //{
        //    try
        //    {
        //        objbrowser.Document.GetElementById(ControlName).InnerText = ControlInnerText;
        ...
        //}
        //  public static void ButtonClickID(WebBrowser objbrowser, string ControlType)
        //{
        //    try
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("input"))
        //        {
        //            if (element.GetAttribute("id") == ControlType)
        //            //if (element.GetAttribute("classname") == ControlName)
        //            {
        //                element.InvokeMember("click");
        //                return;
        ...
        //public static void ButtonClickValue(WebBrowser objbrowser, string ControlType, string ControlValue)
        //{
        //    try
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("input"))
        //        {
        //            if (element.GetAttribute("type") == ControlType && element.GetAttribute("value") == ControlValue)
        //            //if (element.GetAttribute("classname") == ControlName)
        //            {
        //                element.InvokeMember("click");
        //                return;
        ...
        //    }
        //}
        //public static void ButtonClickvalley(WebBrowser objbrowser, string ControlName)
        //{
        //    try
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("button"))
        ...
        //    }
        //}
        //public static void ButtonClick11(WebBrowser objbrowser, string ControlName)
        //{
        //    try
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("input"))
        ...
        //    }
        //}
        //public static void RadioSetValue1(WebBrowser objbrowser, string ControlName, string ControlValue)
        //{
        //    try
        //    {
        ...
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("input"))
        //        {
        //            if (element.GetAttribute("name") == ControlName && element.GetAttribute("type").Equals("radio"))
        //            {

        //                element.SetAttribute("value", ControlValue);
        //                element.SetAttribute("checked", "true");
        //                // element.Document.Forms(ControlValue) = true;
        //                // element.InvokeMember("click");
        ...
        //    { }
        //}
        //public static void LinkInvokepic2(WebBrowser objbrowser)
        //{
        //    try
        //    {
        ...
        //        foreach (HtmlElement link in links)
        //        {
        //            if (link.InnerText.Contains("Return to my ads"))
        //            {
        ...
        //public static void LinkInvokeMotoSeller(WebBrowser objbrowser)
        //{
        //    try
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("a"))
        ...
        //public static void SetClassValue1(WebBrowser objbrowser, string controlName, string Controlvalue)
        //{
        //    try
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("body"))
        //        {
        //            if (element.GetAttribute("style") == controlName)

        //            // if (element.InnerText.Contains(controlName))
        //            {
        //                objbrowser.Document.GetElementById(controlName).InnerText = Controlvalue;
        //                // element.SetAttribute("adtitle", Controlvalue);
        //            }
        ...
        //public static void SetClassValuedes(WebBrowser objbrowser, string controlName, string Controlvalue)
        //{
        //    try
        //    {
        //        foreach (HtmlElement element in objbrowser.Document.GetElementsByTagName("body"))
        //        {
        //            if (element.GetAttribute("class").Trim() == controlName)
