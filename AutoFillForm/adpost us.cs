...
{
   public class adpost_us:IWebSites
    {
       ...
       public void carpostfunc(WebBrowser webBrowser1, IList<com.unitedcarexchange.UsedCarsInfo> obUsedCarsInfo,bool a)
       {
          ...
          string price = "Price: " + "$" + (obUsedCarsInfo[0].Price.ToString() == "0" ? "1" : obUsedCarsInfo[0].Price.ToString() == "Emp" ? "" : obUsedCarsInfo[0].Price.ToString() == "Unspecified" ? "" : obUsedCarsInfo[0].Price.ToString());
           ...
           GeneralFunction.SetTextValue(webBrowser1, "model", username);
           GeneralFunction.SetDropDownName(webBrowser1, "make", obUsedCarsInfo[0].Make.ToString());
           GeneralFunction.SetDropDownName(webBrowser1, "year", obUsedCarsInfo[0].YearOfMake.ToString());
           GeneralFunction.SetTextValue(webBrowser1, "name", username);
